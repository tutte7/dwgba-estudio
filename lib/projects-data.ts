  ...
  corporativos: {
    info: {
      ...
      projects: [
        ...
        {
          id: "working-co-niceto-vega",
          title: "Working & Co - Niceto Vega",
          year: "2024",
          location: "Niceto Vega, Palermo",
          image: "/workingco/1 (7).jpg",
          size: "large" as const,
        },
        {
          id: "alaire",
    ...
    projects: {
      ...
      "robinson-1": {
        ...
        status: "Completado",
        description:
          "Proyecto de diseño interior contemporáneo que combina funcionalidad y estética moderna. El espacio ha sido cuidadosamente diseñado para crear un ambiente sofisticado y acogedor, maximizando el uso del espacio disponible y aprovechando la luz natural.",
        details: {
          "Tipología": "Diseño Interior",
          "Área": "120 m²",
          "Cliente": "Cliente Privado",
        ...
        heroImage: "/robinson-1/1 (5).jpg",
        images: [
          { src: "/robinson-1/1 (5).jpg", alt: "Vista principal del interior" },
          { src: "/robinson-1/2 (3).jpg", alt: "Área de estar" },
          { src: "/robinson-1/3 (4).jpg", alt: "Detalle de diseño" },
          { src: "/robinson-1/4 (2).jpg", alt: "Espacio integrado" },
          { src: "/robinson-1/5 (3).jpg", alt: "Vista general del ambiente" },
        ],
      },
      "robinson-2": {
        id: "robinson-2",
        ...
        status: "Completado",
        description:
          "Diseño interior moderno que refleja elegancia y funcionalidad. Este proyecto desarrolla una propuesta espacial que integra áreas sociales y privadas con una paleta de materiales contemporáneos, creando ambientes fluidos y confortables que responden a las necesidades del cliente.",
        details: {
          "Tipología": "Diseño Interior",
          "Área": "115 m²",
          "Cliente": "Cliente Privado",
        ...
        heroImage: "/robinson-2/1 (6).jpg",
        images: [
          { src: "/robinson-2/1 (6).jpg", alt: "Vista principal del interior" },
          { src: "/robinson-2/2 (4).jpg", alt: "Área de estar principal" },
          { src: "/robinson-2/3 (1) (2).jpg", alt: "Detalle arquitectónico" },
          { src: "/robinson-2/4 (3).jpg", alt: "Espacio integrado" },
          { src: "/robinson-2/5 (4).jpg", alt: "Vista general del proyecto" },
        ],
      },
      "working-co-niceto-vega": {
        id: "working-co-niceto-vega",
        title: "Working & Co - Niceto Vega",
        category: "corporativos",
        year: "2024",
        ...
        status: "Completado",
        description:
          "Proyecto integral de diseño de coworking en Niceto Vega, Palermo. El espacio ha sido diseñado para fomentar la colaboración y creatividad, con áreas de trabajo flexibles, salas de reuniones equipadas, zonas de descanso y espacios comunes que promueven el networking y la productividad.",
        details: {
          "Tipología": "Oficinas de Coworking",
          "Área": "950 m²",
          "Cliente": "Working & Co",
        ...
        heroImage: "/workingco/1 (7).jpg",
        images: [
          { src: "/workingco/1 (7).jpg", alt: "Vista general del espacio de coworking" },
          { src: "/workingco/2 (5).jpg", alt: "Área de trabajo colaborativo" },
          { src: "/workingco/4 (4).jpg", alt: "Zona de descanso y networking" },
          { src: "/workingco/6 (2).jpg", alt: "Espacios de reunión" },
          { src: "/workingco/(4) hall.HEIC", alt: "Hall de entrada" },
        ],
      },
    },
  },
